...
/**
 * SponsorNotice — pill discreta e rápida avisando que a próxima ação pode
 * abrir uma página de patrocinador. Some quando o gate é consumido ou quando
 * o usuário dispensa. Não bloqueia nada.
 */
